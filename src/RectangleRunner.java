...
public class RectangleRunner {
    public static void main(String[] args) {
        ...
        System.out.println("Rectangle's 1 Area: "+ rect1.calculateArea() + ", Box Volume: "+ rect1.calculateBoxVolume(rect1Height));
        System.out.println("Rectangle's 2 Area: "+ rect2.calculateArea() + ", Box Volume: "+ rect2.calculateBoxVolume(rect1Height));
